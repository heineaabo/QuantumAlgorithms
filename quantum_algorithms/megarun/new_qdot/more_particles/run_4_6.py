...
omegas = [0.5,1.0,1.5,2.0] # omegas[[i for i in range(0,len(omegas),5)]]
...
## UCCSDr
np.save('UCCSD_E.npy',Es_ideal_UCC)
np.save('UCCSD_var.npy',VARs_ideal_UCC)
np.save('UCCSD_coeff.npy',vqe_coeffs_ideal_UCC)
