...
plt.plot(x,fci,label='FCI')
plt.plot(x,hf,label='HF')
plt.plot(x,ryrz_n,'.',label='RYRZ')
plt.plot(x,uccdr_n,'+',label='UCCDr')
plt.plot(x,uccsd_n,'*',label='UCCSD')
plt.legend()

plt.figure()
plt.plot(x,np.abs(fci-ryrz_i),'.',label='RYRZ')
plt.plot(x,np.abs(fci-uccdr_i),'+',label='UCCDr')
