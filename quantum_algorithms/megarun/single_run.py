...
for R in tqdm(Rs):
    ...
    ## Noisy
    #model = VQE(h2,Minimizer('Cobyla',tol=1/(100*shots),disp=False),'UCCSD',options=option_noisy_RY)
    #theta = model.optimize()
...
# RYRZ
np.save('H2/five_param/single_RYRZ_E.npy',Es_ideal_RYRZ)
np.save('H2/five_param/single_RYRZ_coef.npy',vqe_coeffs_ideal_RYRZ)
# UCC
np.save('H2/five_param/single_UCCSDr_E.npy',Es_ideal_UCCr)
np.save('H2/five_param/single_UCCSDr_coef.npy',vqe_coeffs_ideal_UCCr)
