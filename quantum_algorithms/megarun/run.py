...
for R in tqdm(Rs):
    ...
    theta = model.optimize()
    print('Ideal converged after {} iterations!'.format(model.evals))
    ...
    theta = model.optimize()
    print('Noisy converged after {} iterations!'.format(model.evals))
...
np.save('H2/five_param/E_ideal_UCCDr.npy',Es_ideal_UCCr)
np.save('H2/five_param/var_ideal_UCCDr.npy',VARs_ideal_UCCr)
np.save('H2/five_param/coeff_ideal_UCCDr.npy',vqe_coeffs_ideal_UCCr)
np.save('H2/five_param/E_noisy_UCCDr.npy',Es_noisy_UCCr)
np.save('H2/five_param/var_noisy_UCCDr.npy',VARs_noisy_UCCr)
np.save('H2/five_param/coeff_noisy_UCCDr.npy',vqe_coeffs_noisy_UCCr)
